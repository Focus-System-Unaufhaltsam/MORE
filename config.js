// ==========================================
// MORE / UNAUFHALTSAM CONFIG
// Safe skin build: no official MORE marks are included.
// Replace more_mark.svg with licensed brand assets only if you have permission.
// ==========================================
window.UNAUFHALTSAM_CONFIG = {
  ...
  startDesc: "No noise. No comfort. One mistake ends the system.",
  startButton: "START SYSTEM",
  boxOverlayText: "FOCUS",
  mythText: "LEVEL 30 WALL: NOT FOR TOURISTS",

  brandColor: "#F05A28",
  logoFileName: "more_mark",
  logoFallbacks: ["more_mark.svg", "more_wordmark.svg"],
  ...
  quotes: [
    ...
    '"Elite zone. Control the system."',
    '"UNAUFHALTSAM. You broke the Level 30 wall. Respect."'
  ],

  shareText: "I played the MORE UNAUFHALTSAM Challenge. Level 30 is the wall.",
